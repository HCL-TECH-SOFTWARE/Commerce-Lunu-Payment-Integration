      ...
      if (response && response.usablePaymentInformation) {
        ...
        for (let payment of response.usablePaymentInformation) {
          if (
            ...
            payment.paymentMethodName === PAYMENT.paymentMethodName.cybersource
          ) {
            ...
            payment.paymentMethodName === PAYMENT.paymentMethodName.googlepay ||
            payment.paymentMethodName === PAYMENT.paymentMethodName.applepay ||
            payment.paymentMethodName === PAYMENT.paymentMethodName.lunu
          ) {
